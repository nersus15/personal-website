...
<body>
    ...
    <section id="projects" class="content-section">
        ...
        <div class="projects-container">
            ...
            <div class="project-card">
                <h3>Real-time Dashboard (JS/Node)</h3>
                <p>Built a responsive dashboard using Vue.js/React and Node.js for real-time data visualization and management.</p>
                <div class="project-links">
                    <a href="#" target="_blank" class="lime-link">Live Demo</a> |
                    <a href="#" target="_blank" class="lime-link">GitHub Repo</a>
                </div>
    ...
    <section id="contact" class="content-section contact-section">
        ...
        <p>Let's discuss your project or opportunity. Fill out the form below!</p>
